...
public class UserController {
    ...
    public void signIn (@RequestBody User user) {
        ...
        //TODO : validation login + mot de passe (alphanumerique + caractères spéciaux...)
        user.setId(null);
    ...
    public ResponseEntity<String> login(@RequestBody User user) {
            ...
            try {
                ...
                MyUserDetails userDetails = (MyUserDetails) authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(
                                user.getLogin(),
                                user.getPassword()
                        )
                ).getPrincipal();
